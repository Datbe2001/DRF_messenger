...
SECRET_KEY = 'django-insecure-enm6bng(5(=5qizx+#+soaey5w$2z0l&*+)9v4!($l7jllx7u&'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': os.environ.get('SECRET_KEY', 'your-default-secret-key'),
    'VERIFYING_KEY': None,
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', "message"),
